...
export const PRE_ARRIVAL_MAX_HOURS = 50;
export const PRE_ARRIVAL_MIN_HOURS = 6;

export const DEPOSIT_BIZUM = '+34 657 07 79 10';
export const DEPOSIT_IBAN = 'ES89 1583 0001 1290 7076 0351';
export const DEPOSIT_ACCOUNT_HOLDER = 'Manon Christophe Massart';
