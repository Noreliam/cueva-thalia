...
export default function BookingForm({
  ...
  const labels = {
    fr: {
      ...
      hoursNotice: 'Arrivée à partir de 15h00 · Départ avant 12h00.',
    ...
    es: {
      ...
      hoursNotice: 'Llegada a partir de las 15:00 · Salida antes de las 12:00.',
    ...
    en: {
      ...
      hoursNotice: 'Arrival from 15:00 · Departure before 12:00.',
